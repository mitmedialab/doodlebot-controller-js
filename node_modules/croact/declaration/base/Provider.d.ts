...
export declare function getCurrentInstance(): Provider<Element | Node | Component> | HooksProvider;
export declare function getHooksIndex(): number;
export declare function setHooksInex(nextHooksIndex: number): void;
export declare function setCurrentInstance(provider: Provider | HooksProvider | null): void;
