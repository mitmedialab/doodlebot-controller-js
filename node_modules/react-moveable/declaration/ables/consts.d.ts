export declare const MOVEABLE_ABLES: readonly [{
    ...
    readonly props: (keyof readonly ["pinchable"])[];
    ...
    name: string;
    props: readonly ["draggable", "throttleDrag", "throttleDragRotate", "startDragRotate", "edgeDraggable"];
    ...
    name: string;
    props: readonly ["defaultGroupRotate", "defaultGroupOrigin", "groupable", "groupableProps", "targetGroups", "hideChildMoveableDefaultLines"];
    events: readonly [];
    ...
    readonly events: readonly [];
    readonly props: (keyof readonly ["clickable"])[];
